...
public class RegisterUser {
	...
	public static void enroll(){
		try {
			...
			props.put("pemFile",
					ChainCodeUtil.baseNetworkConfigPath+"/test-network/organizations/peerOrganizations/org1.example.com/ca/ca.org1.example.com-cert.pem");
